...
infilename = "sorted_openideo_CFgt1_DFgt50_90_ASP_composition.txt"
outfilename = "e-waste-cosines_openideo_CFgt1_DFgt50_90_ASP_.txt"
queryindex = 1006
indexstart = 1113
indexstop = 1311
...
#challenge brief
rawquery = doc_topic_weights[queryindex].split()
query = []
for i in xrange(1,len(rawquery)):
   query.append(float(rawquery[i])) 

#inspirations
rawindex = doc_topic_weights[indexstart:indexstop+1]
cleanindex = []
